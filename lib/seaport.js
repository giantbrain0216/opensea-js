                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                ...
                                value: 0,
                                data: schema_1.encodeCall(contracts_1.getMethod(contracts_1.WrappedNFTLiquidationProxy, "wrapNFTs"), [
                                    tokenIds,
                                    tokenAddresses,
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                ...
                                to: this._wrappedNFTLiquidationProxyAddress,
                                value: 0,
                                data: schema_1.encodeCall(contracts_1.getMethod(contracts_1.WrappedNFTLiquidationProxy, "unwrapNFTs"), [
                                    tokenIds,
                                    tokenAddresses,
                                    destinationAddresses,
                                    isMixedBatchOfAssets,
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.sendRawTransaction(this.web3, {
                                ...
                                to: token.address,
                                value: 0,
                                data: schema_1.encodeCall(contracts_1.getMethod(contracts_1.CanonicalWETH, "withdraw"), [
                                    amount.toString(),
                                ]),
                            }, function (error) {
                                _this._dispatch(types_1.EventType.TransactionDenied, { error: error, accountAddress: accountAddress });
                ...
                switch (_e.label) {
                    ...
                    case 9:
                        ...
                        approvalOneCheck = function () { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, utils_1.promisifyCall(function (c) {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        wyAssets = assets.map(function (asset) {
                            return utils_1.getWyvernAsset(_this._getSchema(asset.schemaName), asset);
                        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, utils_1.getTransferFeeSettings(this.web3, {
                                asset: asset,
                                accountAddress: accountAddress,
                            })];
                    case 2:
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.rawCall(this.web3, {
                                from: accountAddress,
                                to: tokenAddress,
                                data: schema_1.encodeCall(contracts_1.getMethod(contracts_1.ERC20, "allowance"), [
                                    accountAddress,
                                    addressToApprove,
                                ]),
                            })];
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, {
                                ...
                                englishAuctionReservePrice: reservePrice
                                    ? utils_1.makeBigNumber(reservePrice)
                                    : undefined,
                                feeMethod: feeMethod,
                                feeRecipient: feeRecipient,
                                side: types_1.OrderSide.Sell,
                ...
                switch (_j.label) {
                    case 0:
                        ...
                        quantityBNs = quantities.map(function (quantity, i) {
                            return wyvern_js_1.WyvernProtocol.toBaseUnitAmount(utils_1.makeBigNumber(quantity), assets[i].decimals || 0);
                        });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 14:
                        ...
                        throw new Error("Failed to authorize transaction: \"" + (error_14.message ? error_14.message : "user denied") + "...\"");
